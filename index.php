...
// Validasi Ganda: Kamera bisa diakses jika Dosen sudah login DAN sudah memilih kelas aktif
if (!isset($_SESSION['dosen_logged_in']) || !isset($_SESSION['active_matkul_id'])) {
    // Jika belum login dosen atau belum pilih matkul, paksa ke login portal dosen
